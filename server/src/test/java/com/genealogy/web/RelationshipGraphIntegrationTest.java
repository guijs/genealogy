...
@WebMvcTest({RelationshipController.class, GraphController.class})
@Import({FamilyStore.class, PersonStore.class, KinshipStore.class, ProjectionStore.class,
        RelationshipService.class, GraphService.class,
        AuthFilter.class, FamilyMembershipFilter.class, WriteAccessFilter.class})
class RelationshipGraphIntegrationTest {
